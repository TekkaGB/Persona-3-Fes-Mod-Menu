SET COMPILER="D:\Modding Tools\Atlus-Script-Tools\Build\Debug\AtlusScriptCompiler.exe"

SET OUTPUT_PATH=D:\Modding Tools\Persona\AemulusModManager\bin\Release\Packages\Persona 3 FES\P3 Fes Mod Menu
